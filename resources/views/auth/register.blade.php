            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="node" class="col-md-4 col-form-label text-md-end">Node</label>

                            <div class="col-md-6">
                                <input id="node" type="text" class="form-control @error('node') is-invalid @enderror" name="node" value="{{ old('node') }}" required autocomplete="node" autofocus>
